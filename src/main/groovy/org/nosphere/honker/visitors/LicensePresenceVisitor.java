...
public class LicensePresenceVisitor
    implements DepTreeVisitor
{
    private final Set<DepTreeData.Artifact> artifactsWithoutLicense = new LinkedHashSet<>();

    public Set<DepTreeData.Artifact> artifactsWithoutLicense()
    {
