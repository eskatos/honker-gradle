...
public class LicensingReportVisitor
    implements DepTreeVisitor
{
    ...
    {
        System.out.println( StringUtils.repeat( " ", indent * 2 ) + "Visit Enter >> " + node );
        indent++;
        return true;
    }
    ...
    {
        indent--;
        // System.out.println( StringUtils.repeat( " ", indent * 2 ) + "Visit Exit  << " + node );
        return true;
    }
}
